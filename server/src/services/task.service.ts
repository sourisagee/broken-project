...
class TaskService {
  ...
  static async updateTask(
    ...
    try {
      ...
      const taskInstance = taskToUpdate as Model & { title: string; genre: string, description: string };

      if (data.title !== undefined) taskInstance.title = data.title;
      if (data.genre !== undefined) taskInstance.genre = data.genre;
      if (data.description !== undefined) taskInstance.description = data.description;
